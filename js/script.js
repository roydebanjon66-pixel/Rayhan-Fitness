document.addEventListener('DOMContentLoaded', () => {
    ...
    const goalData = {
        weight: { subtitle: "🏆 Premium Fitness Center – Dhanmondi", title: "LOSE WEIGHT <br><span>FAST & SAFE</span>", desc: "Train with confidence in a modern fitness environment featuring advanced equipment, expert trainers, and personalized workout support." },
        muscle: { subtitle: "🏆 Premium Fitness Center – Dhanmondi", title: "GAIN MUSCLE <br><span>BEYOND LIMITS</span>", desc: "Build strength, improve performance, and achieve your health goals with custom muscle building programs at Rayhan Fitness." },
        fit: { subtitle: "🏆 Premium Fitness Center – Dhanmondi", title: "FORGE YOUR STRENGTH <br><span>UNLEASH YOUR POTENTIAL</span>", desc: "Equipped with advanced gym equipment, professional trainers, and a motivating environment, we provide everything needed for a successful fitness journey." }
    };
